...
package com.moogle.gofast.services.rest.applications;
...
//    public static void main(String... args) throws Exception {
	public static void main(String[] args) throws Exception {
        ...
        final ApplicationContext springContext = new ClassPathXmlApplicationContext(
                new String[] {
                		 "com/moogle/gofast/services/rest/config/applicationContext-common.xml",
                		 "com/moogle/gofast/services/rest/config/applicationContext-hibernate.xml",
                		 "com/moogle/gofast/services/rest/config/applicationContext-gofast-resource.xml",
                		 "com/moogle/gofast/services/rest/config/applicationContext-root-router.xml",
                		 "com/moogle/gofast/services/rest/config/applicationContext-server.xml"});
